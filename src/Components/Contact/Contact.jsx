          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-green-600 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">متاح 24/7 للرد على استفساراتكم</p>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-green-600 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">راسلنا وسنرد خلال 24 ساعة</p>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border-l-4 border-green-600 flex items-start gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-800">لمقر الرئيسي</h3>
                <p className="text-gray-500 text-sm">Beni-Sueif</p>
              </div>
            </div>
          </div>
            ...
            <form className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input type="text" className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition" placeholder="Nahla Salah" />
                </div>
                <div>
